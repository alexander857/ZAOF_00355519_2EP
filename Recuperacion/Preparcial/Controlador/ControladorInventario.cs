...
namespace Preparcial.Controlador
{
    ...
    {
        //SE QUITARON ALGUNOS TRYCATCH DE LOS METODOS Y SE PUSIERON EN EL FRMMAIN YA QUE ES MEJOR MANEJAR LAS
        //EXCEPCIONES AHI
        ...
        public static List<Inventario> GetProductos()
        {
            ...
            try
            {
                ...
                // Por cada fila del DataTable, crear un nuevo <<Un nuevo producto>> anadiendolo a la lista
        ...
        {
            //se quita el trycatch ya que ya se esta manejando en el FrmMain las excepciones
